...
public class FunctionRicercaRipartizioni extends FunctionProjectWebApp_base {

    public FunctionRicercaRipartizioni(ApplicationServices_itf applServices, String functionID, String functionName) {
