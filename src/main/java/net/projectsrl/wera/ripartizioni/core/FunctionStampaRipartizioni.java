...
public class FunctionStampaRipartizioni extends FunctionStampaPDFGeneric_base<CreateRipartizioniPdf> {

    public FunctionStampaRipartizioni() {

        super();
    }

    public FunctionStampaRipartizioni(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected void setData(SsbServletRequest req, Map<String, Object> data) throws AppCrash {
        ...
        fillDataFromSingleRowDataSet("DSRipartizioniStampa", data, param);
        ...
        try {
            ...
            dataSet = dsFactory.makeDataSet("", "DSRipartizioniDettaglioLettureStampa");
            //param.put("WHERECONDITION", " WHERE RI.ID_MODULO=" + idModulo+" AND RDS.ID_MODULO=" + idModulo);
