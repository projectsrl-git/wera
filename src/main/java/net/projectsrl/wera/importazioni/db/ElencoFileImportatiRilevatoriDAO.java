...
public class ElencoFileImportatiRilevatoriDAO extends AliModDAO_base {
	...
	private static final String TABLE_NAME = "ELENCO_FILE_IMPORTATI_RILEVATORI";
	...
	public ElencoFileImportatiRilevatoriDAO() throws AppCrash {

		super(TABLE_NAME);
	}

	public ElencoFileImportatiRilevatoriDAO(DBTransaction transact) throws AppCrash {

		super(transact, TABLE_NAME);
	}

	public ElencoFileImportatiRilevatoriDAO(DBTransaction transact, String tableName) throws AppCrash {
