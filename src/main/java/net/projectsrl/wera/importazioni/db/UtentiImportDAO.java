...
import net.projectsrl.dafne.db.LingueISODAO;
import net.projectsrl.dafne.db.PasswordDAO;
import net.projectsrl.dafne.db.UtentiAziendeDAO;
import net.projectsrl.dafne.db.UtentiLingueDAO;
...
public class UtentiImportDAO extends PjNDAO_base {
    ...
    public UtentiImportDAO() throws AppCrash {

        super(TABLE_NAME);
    }

    public UtentiImportDAO(DBTransaction transact) throws AppCrash {
    ...
    public void insert() throws AppCrash {
        ...
        // inserisce profilo
        if (Util.IsEmpty(_profili)) {
        	_profili = "3";
        }
        new UtentiProfiliDAO().insert(_profili, idUtente);

        // inserisce aziende
        if (Util.IsEmpty(_aziende)) {
        	_aziende = "1";
        }
