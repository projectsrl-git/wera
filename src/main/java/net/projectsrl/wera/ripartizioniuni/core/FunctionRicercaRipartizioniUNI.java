...
public class FunctionRicercaRipartizioniUNI extends FunctionProjectWebApp_base {

    public FunctionRicercaRipartizioniUNI(ApplicationServices_itf applServices, String functionID, String functionName) {
