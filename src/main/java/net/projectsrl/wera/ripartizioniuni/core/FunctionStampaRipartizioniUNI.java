...
public class FunctionStampaRipartizioniUNI extends FunctionStampaPDFGeneric_base<CreateRipartizioniUNIPdf> {

    public FunctionStampaRipartizioniUNI() {

        super();
    }

    public FunctionStampaRipartizioniUNI(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected void setData(SsbServletRequest req, Map<String, Object> data) throws AppCrash {
        ...
        fillDataFromSingleRowDataSet("DSRipartizioniUNIStampa", data, param);
        ...
        try {
            dataSet = dsFactory.makeDataSet("", "DSRipartizioniUNIDettaglioLettureStampa");
