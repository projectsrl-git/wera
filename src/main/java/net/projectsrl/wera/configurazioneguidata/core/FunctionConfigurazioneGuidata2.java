...
import net.projectsrl.wera.anagrafiche.core.FunctionInserimentoAnagraficaAntenne;

public class FunctionConfigurazioneGuidata2 extends FunctionInserimentoAnagraficaAntenne {

    public FunctionConfigurazioneGuidata2(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected String getPathDescription(Map<String, Object> map) {
        ...
        try {
            ...
            pathDescri = "Home / Configurazione guidata / Anagrafica antenne";
