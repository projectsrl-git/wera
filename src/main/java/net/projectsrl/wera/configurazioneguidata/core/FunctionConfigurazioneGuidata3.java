...
import net.projectsrl.wera.anagrafiche.core.FunctionInserimentoAnagraficaContatori;

public class FunctionConfigurazioneGuidata3 extends FunctionInserimentoAnagraficaContatori {

    public FunctionConfigurazioneGuidata3(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected String getPathDescription(Map<String, Object> map) {
        ...
        try {
            ...
            pathDescri = "Home / Configurazione guidata / Anagrafica contatori";
