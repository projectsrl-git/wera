...
import net.projectsrl.wera.importazioni.core.FunctionImportDatiRilevatori;

public class FunctionConfigurazioneGuidata5 extends FunctionImportDatiRilevatori {

	 public FunctionConfigurazioneGuidata5(ApplicationServices_itf applServices, String functionID, String functionName) {
	    ...
	    protected String getPathDescription(Map<String, Object> map) {
	        ...
	        try {
	            ...
	            pathDescri = "Home / Configurazione guidata / Scarico rilevatori";
