...
import net.projectsrl.wera.anagrafiche.core.FunctionInserimentoAnagraficaUtenze;

public class FunctionConfigurazioneGuidata4 extends FunctionInserimentoAnagraficaUtenze {

    public FunctionConfigurazioneGuidata4(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected String getPathDescription(Map<String, Object> map) {
        ...
        try {
            ...
            pathDescri = "Home / Configurazione guidata / Anagrafica utenze";
