...
import net.projectsrl.wera.anagrafiche.core.FunctionInserimentoAnagraficaCondomini;

public class FunctionConfigurazioneGuidata1 extends FunctionInserimentoAnagraficaCondomini {

    public FunctionConfigurazioneGuidata1(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected String getPathDescription(Map<String, Object> map) {
        ...
        try {
            ...
            pathDescri = "Home / Configurazione guidata / Anagrafica condomini";
