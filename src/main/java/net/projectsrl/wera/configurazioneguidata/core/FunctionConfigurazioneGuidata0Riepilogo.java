...
import net.projectsrl.wera.importazioni.core.FunctionRiepilogoDatiAnagraficaUtenze;

public class FunctionConfigurazioneGuidata0Riepilogo extends FunctionRiepilogoDatiAnagraficaUtenze {

    public FunctionConfigurazioneGuidata0Riepilogo(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected String getPathDescription(Map<String, Object> map) {
        ...
        try {
            ...
            pathDescri = "Home / Configurazione guidata / Riepilogo importazione anagrafica utenze";
