...
import net.projectsrl.wera.ripartizioniuni.core.FunctionInserimentoRipartizioniUNI;

public class FunctionConfigurazioneGuidata6 extends FunctionInserimentoRipartizioniUNI {

    public FunctionConfigurazioneGuidata6(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected String getPathDescription(Map<String, Object> map) {
        ...
        try {
            ...
            pathDescri = "Home / Configurazione guidata / Ripartizione UNI 10200-2015";
