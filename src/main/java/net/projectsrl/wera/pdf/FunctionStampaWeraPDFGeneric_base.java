...
package net.projectsrl.wera.pdf;
...
public abstract class FunctionStampaWeraPDFGeneric_base<P extends CreateWeraPDF> extends FunctionStampaWeraPDF_base {

    public FunctionStampaWeraPDFGeneric_base() {

        super();

    }

    public FunctionStampaWeraPDFGeneric_base(ApplicationServices_itf applServices, String functionID, String functionName) {
