...
public abstract class FunctionStampaWeraPDF_base extends FunctionProjectWebApp_base {

    public static final String OUTPUT_PATH = WebAppConstants_itf.OUTPUT_PATH;

    public FunctionStampaWeraPDF_base() {

        super();
    }

    public FunctionStampaWeraPDF_base(ApplicationServices_itf applServices, String functionID, String functionName) {
