...
//TODO void printData
public abstract class CreateWeraPDF {
    ...
    public CreateWeraPDF(String templateFile, String outDirectory, Map<String, Object> map) {
    ...
    public CreateWeraPDF(String outDirectory, Map<String, Object> map) {
    ...
    public String createPDF() throws AppCrash {
        ...
        try {
            ...
            while (!printEnded) {
                ...
                List<Map<String, Object>> report = (List<Map<String, Object>>) _map.get(CreateWeraPDF.LIST_OF_ROWS);
