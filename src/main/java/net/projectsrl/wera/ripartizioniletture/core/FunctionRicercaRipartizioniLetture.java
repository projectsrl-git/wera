...
public class FunctionRicercaRipartizioniLetture extends FunctionProjectWebApp_base {

    public FunctionRicercaRipartizioniLetture(ApplicationServices_itf applServices, String functionID, String functionName) {
