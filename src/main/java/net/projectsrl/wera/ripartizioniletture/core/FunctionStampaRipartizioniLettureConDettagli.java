...
import net.projectsrl.wera.pdf.FunctionStampaWeraPDFGeneric_base;

public class FunctionStampaRipartizioniLettureConDettagli extends FunctionStampaWeraPDFGeneric_base<CreateRipartizioniLettureConDettagliPdf> {

    public FunctionStampaRipartizioniLettureConDettagli() {

        super();
    }

    public FunctionStampaRipartizioniLettureConDettagli(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected void setData(SsbServletRequest req, Map<String, Object> data) throws AppCrash {
        ...
        try {
            dataSet = dsFactory.makeDataSet("", "DSRipartizioniLettureDettaglioStampaConDettagli");
            ...
            ac.logContext(this.getClass().getName(),"Errore nella ricerca dell'ultimo progressivo del dataset " + "DSRipartizioniLettureDettaglioStampa");
        } finally {
