...
public class FillFlattenMerge2 {
   ...
   public static final String SRC = "d:/works/state.pdf";
   public static final String DEST = "d:/works/united_states_2.pdf";
   public static final String DATA = "d:/works/united_states.csv";
   ...
   public void manipulatePdf(String src, String dest) throws DocumentException, IOException {
       ...
       while ((line = br.readLine()) != null) {
           ...
           PdfImportedPage pageTemp = copy.getImportedPage(reader, 1);
           copy.addPage(pageTemp);
           reader.close();
       }
       br.close();
       document.close();
