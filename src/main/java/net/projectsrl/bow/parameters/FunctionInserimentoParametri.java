...
public class FunctionInserimentoParametri extends FunctionAjaxForm_base<ParametriDAO> {

    public FunctionInserimentoParametri(ApplicationServices_itf applServices, String functionID, String functionName) {
