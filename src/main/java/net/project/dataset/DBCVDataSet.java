 ...
 * </p>
 */
public class DBCVDataSet implements DataSet_itf {
     ...
     */
    public DBCVDataSet(String configName, String dsName) throws AppCrash {
    ...
    protected void getDbConnection() throws AppCrash {
        ...
        String url = Config.GetInstance().getProperty("DB.ConnectionURL");

        String dbHostName = readDBHostName();
        Config.GetInstance().setProperty("DB.ConnectionURL", "jdbc:jtds:sqlserver://" + dbHostName + "/AQ_PROJECTSRL");
        ...
        Config.GetInstance().setProperty("DB.ConnectionURL", url);
