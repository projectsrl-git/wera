 ...
 */
public class PopupDBConnection extends DBConnection {
     ...
     * @exception AppCrash
     */
    public PopupDBConnection(String url, String user, String password) throws AppCrash {
