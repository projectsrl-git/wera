 ...
 * @author zorzetti
 */
public class SaxXMLRequestParser extends DefaultHandler {
     ...
     */
    public SaxXMLRequestParser() throws AppCrash {
    ...
    public synchronized void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        String cbuf = _currentBuffer.toString();
        if (cbuf.trim().length() > 0) {
            _campi.put(localName, cbuf);
        }
        _currentBuffer = null;
    }
