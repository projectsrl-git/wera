...
DROP TABLE IF EXISTS RIPARTIZIONI_UNI CASCADE;

-- CREATE TABLES SECTION -------------------------------------------------


-- TABLE RIPARTIZIONI_UNI

 create table ripartizioni_uni(
...
-- add keys for table ripartizioni_uni

alter table ripartizioni_uni add constraint pk_ripartizioni_uni primary key (id_modulo)
;

alter table ripartizioni_uni add constraint k1_ripartizioni_uni unique (id_modulo)
;
