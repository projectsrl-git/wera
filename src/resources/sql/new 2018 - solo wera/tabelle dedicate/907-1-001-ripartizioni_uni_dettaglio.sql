...
drop table if exists ripartizioni_uni_dettaglio cascade;

-- create tables section -------------------------------------------------


-- table ripartizioni_uni_dettaglio

 create table ripartizioni_uni_dettaglio(
...
-- add keys for table ripartizioni_uni_dettaglio

alter table ripartizioni_uni_dettaglio add constraint pk_ripartizioni_uni_dettaglio primary key (id_dettaglio)
;

alter table ripartizioni_uni_dettaglio add constraint k1_ripartizioni_uni_dettaglio unique (id_dettaglio)
;
