...
drop table if exists ripartizioni_letture_dettaglio_singolo cascade;

-- create tables section -------------------------------------------------


-- table ripartizioni_letture_dettaglio_singolo

 create table ripartizioni_letture_dettaglio_singolo(
...
-- add keys for table ripartizioni_letture_dettaglio_singolo

alter table ripartizioni_letture_dettaglio_singolo add constraint pk_ripartizioni_letture_dettaglio_singolo primary key (id_dettaglio)
;

alter table ripartizioni_letture_dettaglio_singolo add constraint k1_ripartizioni_letture_dettaglio_singolo unique (id_dettaglio)
;
